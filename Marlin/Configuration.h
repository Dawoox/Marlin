...
#define STRING_CONFIG_H_AUTHOR "Dawoox" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  41.67
  #define DEFAULT_bedKi   7.87
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 800, 100, 3000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25.4, -30.3, -3.6 }
...
#define X_MIN_POS 0 + 7.5
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 7.5
...
#define HOMING_FEEDRATE_MM_M { 5000, 5000, 500 }
...
#define SKEW_CORRECTION
  ...
  #define XY_SKEW_FACTOR -0.018461
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X -11950
  #define TOUCH_CALIBRATION_Y  8450
